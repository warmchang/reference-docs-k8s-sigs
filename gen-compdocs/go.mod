module github.com/kubernetes-sigs/reference-docs/gen-compdocs
...
require (
	...
	k8s.io/endpointslice v0.37.0 // indirect
	k8s.io/externaljwt v0.37.0 // indirect
	k8s.io/kms v0.37.0 // indirect
	k8s.io/kube-aggregator v0.37.0 // indirect
	k8s.io/kube-controller-manager v0.37.0 // indirect
